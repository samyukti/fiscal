...
describe Fiscal do
  ...
  context 'with UK country' do
    ...
    it "returns '2024-04-06' as fiscal year end date of Great Britain for the date '2024-01-22'" do
      Date.fiscal(date: '2024-01-22', country: :gb).year.end.should eql('2024-04-05'.to_date)
    end

    it "returns '2023-04-06' as fiscal year start date of Great Britain for the date '2024-01-22'" do
      Date.fiscal(date: '2024-01-22', country: :gb).year.start.should eql('2023-04-06'.to_date)
    end
  end
